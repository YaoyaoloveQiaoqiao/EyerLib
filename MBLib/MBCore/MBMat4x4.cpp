...
namespace MB {
    MBMat4x4::MBMat4x4() : MBMat(4, 4)
    {

    }

    MBMat4x4::MBMat4x4(const MBMat & _mat) : MBMat(4, 4)
    {
        *this = _mat;
    }

    MBMat4x4 & MBMat4x4::operator = (const MBMat &_mat)
    {
        if(row != _mat.row){
            return *this;
        }
    ...
    int MBMat4x4::SetScale(float x, float y, float z)
    {
        mat[0][0] = x;
        mat[1][1] = y;
        mat[2][2] = z;
    ...
    int MBMat4x4::SetTrans(float x, float y, float z)
    {
        for (int i = 0; i < row; i++) {
            for (int j = 0; j < col; j++) {
                // mat[i][j] = 0.0f;
    ...
    int MBMat4x4::SetRotate(float x, float y, float z, float a)
    {
    ...
    int MBMat4x4::SetOrtho(float l, float r, float t, float b, float near, float far)
    {
    ...
    int MBMat4x4::SetPerspective(float fov, float aspect, float near, float far)
    {
    ...
    int MBMat4x4::SetRotateX(float a)
    {
    ...
    int MBMat4x4::SetRotateY(float a)
    {
    ...
    int MBMat4x4::SetRotateZ(float a)
    {
